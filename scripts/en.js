(function() {
  ...
  window.langs.en = {
    ...
    exp8_1: 'Built backend infrastructure on AWS using ECS, deploying within Docker containers. Developed CI/CD pipelines for efficient build and deployment processes.',
    exp8_2: 'Contributed to various platform features, including chat functionalities, AI personas (via OpenAI API), and file manipulation. Tech stack includes Vue, Node.js, Express, and MongoDB, with responsibilities spanning development, testing, code review, and AWS infrastructure management.',
